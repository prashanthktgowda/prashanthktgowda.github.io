...
To view a live example, **[click here](https://prashanthktgowda.github.io)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/prashanthktgowda/prashanthktgowda.git
  ```
...
- At the bottom of this file you will see the below code:
  ...
  - You need to change the name from `purpleTheme` to whatever theme you want to set your website to
